              ...
              <div className="page-header">
                <div className="row">
                  ...
                  <div className="col-auto float-end ml-auto">
                    <a href="#" className="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_plan"><i className="fa fa-plus" /> Add Subscription</a>
                  </div>
                </div>
              </div>
              {/* /Page Header */}
                  ...
                  <div className="row justify-content-center mb-4">
                    <div className="col-auto">
                      <nav className="nav btn-group">
                        <a href="#monthly" className="btn btn-outline-secondary active show" data-bs-toggle="tab">Monthly Plan</a>
                        <a href="#annual" className="btn btn-outline-secondary" data-bs-toggle="tab">Annual Plan</a>
                      </nav>
                    </div>
                  </div>
                  {/* /Plan Tab */}
                        ...
                        <div className="col-md-4">
                          <div className="card pricing-box">
                            <div className="card-body d-flex flex-column">
                              ...
                              <a href="#" className="btn btn-lg btn-secondary mt-auto" data-bs-toggle="modal" data-bs-target="#edit_plan">Edit</a>
                            </div>
                          </div>
                        </div>
                        <div className="col-md-4">
                  ...
                  <div className="modal custom-modal fade" id="add_plan" tabIndex={-1} role="dialog" aria-hidden="true">
                    <div className="modal-dialog modal-md modal-dialog-centered">
                      <div className="modal-content">
                        <button type="button" className="close" data-bs-dismiss="modal"><i className="fa fa-close" /></button>
