        ...
        <div className="page-header">
          <div className="row align-items-center">
            ...
            <div className="col-auto float-end ml-auto">
              <a href="#" className="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_tax"><i className="fa fa-plus" /> Add Tax</a>
            </div>
          </div>
        </div>
        {/* /Page Header */}
                    ...
                    <td className="text-end">
                      <div className="dropdown dropdown-action">
                        ...
                        <div className="dropdown-menu dropdown-menu-right">
                          <a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_tax"><i className="fa fa-pencil m-r-5" /> Edit</a>
                          <a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_tax"><i className="fa fa-trash-o m-r-5" /> Delete</a>
                        </div>
                      </div>
                    </td>
                  </tr>
