...
const EditAdmin = () => {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                const response = await privateHttp.get(`/Administrators/${uid}`, { cacheTimeout: 300000 })
                        ...
                        <div className="card-body">
                            <form>
                                ...
                                <div className="mt-3 text-center">
                                    <Link to="/app/employee/alladmin" style={{ marginLeft: '10px' }}><button className="btn btn-outline-danger"> Cancel </button></Link>
