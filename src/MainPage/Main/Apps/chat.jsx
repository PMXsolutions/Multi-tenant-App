                  ...
                  <div className="navbar">
                    <div className="user-details me-auto">
                      ...
                      <div className="user-info float-start">
                        <Link to="/app/profile/employee-profile" title="Mike Litorus"><span>Mike Litorus</span> <i className="typing-text">Typing...</i></Link>
                    ...
                    <ul className="nav custom-menu">
                      <li className="nav-item">
                        <a className="nav-link task-chat profile-rightbar float-end" id="task_chat" href="#task_window"><i className="fa fa-user" /></a>
                      </li>
                      <li className="nav-item">
                      ...
                      <li className="nav-item dropdown dropdown-action">
                        <a aria-expanded="false" data-bs-toggle="dropdown" className="nav-link dropdown-toggle" href=""><i className="fa fa-cog" /></a>
              ...
              <div className="chat-window video-window">
                <div className="fixed-header">
                  <ul className="nav nav-tabs nav-tabs-bottom">
                    <li className="nav-item"><a className="nav-link" href="#calls_tab" data-bs-toggle="tab">Calls</a></li>
                    <li className="nav-item"><a className="nav-link active" href="#profile_tab" data-bs-toggle="tab">Profile</a></li>
                  </ul>
                </div>
