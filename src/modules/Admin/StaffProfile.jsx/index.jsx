            ...
            <div className="row">
              <div className="col-sm-12">
                ...
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item"><Link to="/administrator/allStaff">Staff</Link></li>
                        ...
                        <div className="col-md-5">
                          <div className="profile-info-left d-flex flex-column">
                            ...
                            <div className="staff-msg d-flex gap-2">
                              ...
                              <Link to={`/administrator/staffDocum/${staffOne.staffId}`} className="py-1 px-2 rounded text-white bg-danger">Staff Doc</Link>
                            </div>
                          </div>
                        </div>
