...
import { Boxed, Close, compact, Compact, dark, Detached, Horizontal, small_hover, Two_col, Veritical } from "../imagepath";
                ...
                <div className="offcanvas offcanvas-end border-0 " tabIndex={-1} id="theme-settings-offcanvas">
                    <div className="sidebar-headerset">
                        ...
                        <div className="sidebar-headerclose">
                            <a data-bs-dismiss="offcanvas" aria-label="Close"><img src={Close} alt="img" /></a>
                        </div>
                    </div>
                            ...
                            <div className="settings-mains">
                                    ...
                                    <div className="col-4">
                                        <div className="form-check card-radio p-0">
                                            ...
                                            <label className="form-check-label  avatar-md w-100" htmlFor="customizer-layout02">
                                                <img src={Horizontal} alt="img" onClick={changes} onChange={refreshPage} />
                                            </label>
                                        </div>
                                ...
                                <div className="colorscheme-cardradio">
                                    <div className="row">
                                        <div className="col-4">
                                            <div className="form-check card-radio p-0">
                                                <input className="form-check-input" type="radio" name="data-layout-mode" id="layout-mode-orange" defaultValue="orange" />
                                                <label className="form-check-label  avatar-md w-100 " htmlFor="layout-mode-orange">
                                                    <img src={Veritical} alt="img"onClick={OrangeThemes} />
                                                </label>
                                            </div>
                                        ...
                                        <div className="col-4">
                                            <div className="form-check card-radio p-0">
                                                ...
                                                <label className="form-check-label  avatar-md w-100" htmlFor="layout-mode-light">
                                                    <img src={Veritical} alt="img" onClick={LightThemes} />
                                                </label>
                                            </div>
                                        ...
                                        <div className="col-4">
                                            <div className="form-check card-radio blue  p-0 ">
                                                <input className="form-check-input" type="radio" name="data-layout-mode" id="layout-mode-blue" defaultValue="blue" />
                                        ...
                                        <div className="col-4">
                                            <div className="form-check card-radio maroon p-0">
                                                <input className="form-check-input" type="radio" name="data-layout-mode" id="layout-mode-maroon" defaultValue="maroon" />
                                                <label className="form-check-label  avatar-md w-100 " htmlFor="layout-mode-maroon">
                                                    <img src={Veritical} alt="img" onClick={MaroonThemes} />
                                                </label>
                                            </div>
                                        ...
                                        <div className="col-4">
                                            <div className="form-check card-radio purple p-0">
                                                <input className="form-check-input" type="radio" name="data-layout-mode" id="layout-mode-purple" defaultValue="purple" />
                                                <label className="form-check-label  avatar-md w-100 " htmlFor="layout-mode-purple">
                                                    <img src={Veritical} alt="img" onClick={PurpleThemes}/>
                                                </label>
                                            </div>
                                    ...
                                    <div className="col-4">
                                        <div className="form-check card-radio  p-0">
                                            ...
                                            <label className="form-check-label avatar-md w-100" htmlFor="topbar-color-light">
                                                <img src={Veritical} alt="img" onClick={LightBarThemes} />
                                            </label>
                                        </div>
                                        <h5 className="fs-13 text-center mt-2">Light</h5>
                                    </div>
                                        ...
                                        <div className="col-4">
                                            <div className="form-check sidebar-setting card-radio p-0 ">
                                                ...
                                                <label className="form-check-label avatar-md w-100" htmlFor="sidebar-size-small-hover">
                                                    <img src={small_hover} alt="img" onClick={SmallHoverView} />
                                                </label>
                                            </div>
                                        ...
                                        <div className="col-4">
                                            <div className="form-check sidebar-setting card-radio p-0" data-bs-toggle="collapse" data-bs-target="#collapseBgGradient.show">
                                                ...
                                                <label className="form-check-label  avatar-md w-100" htmlFor="sidebar-color-light">
                                                    <span className="bg-light bg-sidebarcolor" onClick={LightStyle} />
                                                </label>
                                            </div>
                                            <h5 className="fs-13 text-center mt-2">Light</h5>
                                        </div>
                                        <div className="col-4">
                                            <div className="form-check sidebar-setting card-radio p-0" data-bs-toggle="collapse" data-bs-target="#collapseBgGradient.show">
                                                ...
                                                <label className="form-check-label  avatar-md w-100" htmlFor="sidebar-color-dark">
                                                    <span className="bg-darks bg-sidebarcolor" onClick={DarkStyle}/>
                                                </label>
                                            </div>
                                            <h5 className="fs-13 text-center mt-2">Dark</h5>
                                        </div>
                                        <div className="col-4">
                                            <div className="form-check sidebar-setting card-radio p-0">
                                                ...
                                                <label className="form-check-label avatar-md w-100" htmlFor="sidebar-color-gradient">
                                                    <span className="bg-gradients bg-sidebarcolor" onClick={GradientStyle} />
                                                </label>
                                            </div>
